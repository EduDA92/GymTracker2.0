...
fun NavGraphBuilder.workoutDiaryScreen(onBackClick: () -> Unit = {}, navigateToExerciseList: (Long) -> Unit = {}) {
    composable(
        ...
        WorkoutDiaryRoute(onBackClick = onBackClick, navigateToExerciseList = navigateToExerciseList)
